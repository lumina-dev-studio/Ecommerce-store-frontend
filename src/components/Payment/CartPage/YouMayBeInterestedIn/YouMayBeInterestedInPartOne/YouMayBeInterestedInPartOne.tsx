...
const YouMayBeInterestedInPartOne = () => {
    const productdData = [
        {
          id:1,
          images : [
  ...
  const responsive = {
    superLargeDesktop: {
      ...
      items: 3, // Show 5 items for xl screens
    },
    desktop: {
      breakpoint: { max: 1199, min: 1024 },
      items: 4, // Show 3 items for large screens
    },
    tablet: {
  ...
  return (
    <div className="relative w-full group mt-5 xl:mt-0 mb-5 xl:mb-0  ">
      <Carousel
...
export default YouMayBeInterestedInPartOne;