  ...
  return (
    <div className=" group"> {/* Apply 'relative' to contain 'absolute' positioned elements */}
      ...
      <section>
        ...
        <p className="text-blue-500 text-[14px] font-[600] mt-2">$3,800.00</p>

        <div className="mt-2">
          <button className="py-2.5 group w-full h-[40px] px-6 text-[15px] flex justify-center items-center text-white bg-blue-500 rounded-lg hover:bg-blue-600 transition duration-300">
